...
- Locations: `frontend/src/navbar/Navbar.tsx:79` (`text-gray-400`), `frontend/src/navbar/ShopDropdown.tsx:215` (`bg-gray-100`), `frontend/src/common/ProductCard.tsx:36` (`bg-gray-100`), `frontend/src/filters/FilterSidebar.tsx:319` (`border-gray-200`).
...
- Location: `frontend/src/common/List.tsx`.
...
- Location: `frontend/src/common/StarRating.tsx`.
...
- Location: `frontend/src/common/HorizontalScrollbar.tsx`.
