...
export const AboutUs = () => {
  return (
    <section className='py-about-us flex w-full flex-col items-center gap-14 border-y-2'>
      <header className='font-crimson text-about-us-header w-2/3 text-center font-medium'>
